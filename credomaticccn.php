...
curl_setopt($ch, CURLOPT_PROXY, 'gate.dc.smartproxy.com:20000');
curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'sp03340225:Syntaxph');
curl_setopt($ch, CURLOPT_URL, 'https://1eaf.cardinalcommerce.com/EAFService/jsp/v1/redirect'); 
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1); 
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0); 
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0); 
curl_setopt_array($ch, [CURLOPT_COOKIEFILE => $posty, CURLOPT_COOKIEJAR => $posty]); 
curl_setopt($ch, CURLOPT_POSTFIELDS, 'PaReq='.$pareq.'&TermUrl=https%3A%2F%2Fcredomatic.compassmerchantsolutions.com%2Fapi%2Ftransact.php%3Fusername%3Dviarsaadmin08%26APISID%3D'.$apisid.'%26centinel_transaction_id%3D'.$centinel_transaction_id.'%26cardholder_auth_key%3D'.$cardholder_auth_key.'&MD=none');

$headers = array(); 
$headers[] = 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:98.0) Gecko/20100101 Firefox/98.0';
$headers[] = 'Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8';
$headers[] = 'Content-Type: application/x-www-form-urlencoded';
$headers[] = 'Origin: https://credomatic.compassmerchantsolutions.com';
$headers[] = 'DNT: 1';
$headers[] = 'Connection: keep-alive';
$headers[] = 'Referer: https://credomatic.compassmerchantsolutions.com/';
$headers[] = 'Upgrade-Insecure-Requests: 1';
$headers[] = 'Sec-Fetch-Dest: document';
$headers[] = 'Sec-Fetch-Mode: navigate';
$headers[] = 'Sec-Fetch-Site: cross-site';
...
$issuerid = GetStr($exe,'issuerId=','&');
$transactionid = GetStr($exe,"&transactionId=","'");
$pareq2 = GetStr($exe,"name='PaReq' value='","'");
$MD = GetStr($exe,"name='MD' value='","'");

$ch = curl_init(); 
curl_setopt($ch, CURLOPT_PROXY, 'gate.dc.smartproxy.com:20000');
curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'sp03340225:Syntaxph');
curl_setopt($ch, CURLOPT_URL, 'https://1eaf.cardinalcommerce.com/EAFService/jsp/v1/profile?payload='.$MD.''); 
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1); 
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0); 
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0); 
...
$headers[] = 'DNT: 1';
$headers[] = 'Connection: keep-alive';
$headers[] = 'Referer: https://1eaf.cardinalcommerce.com/EAFService/jsp/v1/redirect';
$headers[] = 'Upgrade-Insecure-Requests: 1';
...
curl_setopt($ch, CURLOPT_PROXY, 'gate.dc.smartproxy.com:20000');
curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'sp03340225:Syntaxph');
curl_setopt($ch, CURLOPT_URL, 'https://authentication.cardinalcommerce.com/ThreeDSecure/V1_0_2/PayerAuthentication?issuerId='.$issuerid.'&transactionId='.$transactionid.''); 
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1); 
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0); 
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0); 
curl_setopt_array($ch, [CURLOPT_COOKIEFILE => $posty, CURLOPT_COOKIEJAR => $posty]); 
curl_setopt($ch, CURLOPT_POSTFIELDS, 'PaReq='.urlencode($pareq2).'&TermUrl=https%3A%2F%2F1eaf.cardinalcommerce.com%2FEAFService%2Fjsp%2Fv1%2Fterm&MD='.$MD.'');
...
$deviceid = GetStr($exe,'name="DeviceId" type="hidden" value="','"');
$issuerid2 = GetStr($exe,'name="IssuerId" type="hidden" value="','"');

$ch = curl_init(); 
curl_setopt($ch, CURLOPT_PROXY, 'gate.dc.smartproxy.com:20000');
curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'sp03340225:Syntaxph');
curl_setopt($ch, CURLOPT_URL, 'https://authentication.cardinalcommerce.com/api/nextstep/term'); 
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1); 
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0); 
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0); 
curl_setopt_array($ch, [CURLOPT_COOKIEFILE => $posty, CURLOPT_COOKIEJAR => $posty]); 
curl_setopt($ch, CURLOPT_POSTFIELDS, 'TransactionId='.$transactionid.'&IssuerId='.$issuerid.'');
...
$headers[] = 'DNT: 1';
$headers[] = 'Connection: keep-alive';
$headers[] = 'Referer: https://authentication.cardinalcommerce.com/ThreeDSecure/V1_0_2/PayerAuthentication?issuerId='.$issuerid.'&transactionId='.$transactionid.'';
$headers[] = 'Sec-Fetch-Dest: empty';
$headers[] = 'Sec-Fetch-Mode: cors';
$headers[] = 'Sec-Fetch-Site: same-origin';
$headers[] = 'TE: trailers';
...
$exe = curl_exec($ch); 
curl_close($ch);
$pares = GetStr($exe,'"PARes":"','"');
$MD2 = GetStr($exe,'"MD":"','"');

$ch = curl_init(); 
curl_setopt($ch, CURLOPT_PROXY, 'gate.dc.smartproxy.com:20000');
curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'sp03340225:Syntaxph');
curl_setopt($ch, CURLOPT_URL, 'https://1eaf.cardinalcommerce.com/EAFService/jsp/v1/term'); 
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1); 
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0); 
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0); 
curl_setopt_array($ch, [CURLOPT_COOKIEFILE => $posty, CURLOPT_COOKIEJAR => $posty]); 
curl_setopt($ch, CURLOPT_POSTFIELDS, 'PaRes='.urlencode($pares).'&MD='.$MD2.'');
...
$headers[] = 'DNT: 1';
$headers[] = 'Connection: keep-alive';
$headers[] = 'Referer: https://authentication.cardinalcommerce.com/';
$headers[] = 'Upgrade-Insecure-Requests: 1';
$headers[] = 'Sec-Fetch-Dest: iframe';
$headers[] = 'Sec-Fetch-Mode: navigate';
$headers[] = 'Sec-Fetch-Site: same-site';
...
$exe = curl_exec($ch); 
curl_close($ch);
$pares2 = GetStr($exe,"name=\"PaRes\" value='","'");
